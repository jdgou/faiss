 ...
 ********************************************************************/
    ...
    namespace {
        ...
        struct SQScannerIP: InvertedListScanner {
            DCClass dc;
            ...
            SQScannerIP(int d, const std::vector<float> & trained,
                               ...
                               size_t k) const override
            {
                ...
                for (size_t j = 0; j < list_size; j++) {
                    ...
                    float accu = accu0 + dc.query_to_code (codes + offset * code_size);

                    if (accu > simi [0]) {
                        minheap_pop (k, simi, idxi);
                        minheap_push (k, simi, idxi, accu, offset);
                        nup++;
                    }
                }
                return nup;
        ...
        template<class DCClass>
        struct SQScannerL2: InvertedListScanner {
            ...
            SQScannerL2(int d, const std::vector<float> & trained,
                               ...
                               size_t k) const override
            {
                ...
                for (size_t j = 0; j < list_size; j++) {
                    ...
                    float dis = dc.query_to_code (codes + offset * code_size);

                    if (dis < simi [0]) {
                        maxheap_pop (k, simi, idxi);
                        maxheap_push (k, simi, idxi, dis, offset);
                        nup++;
                    }
                }
                return nup;
        ...
        InvertedListScanner* sel12_scanner
                (const ScalarQuantizer *sq,
                 const Index *quantizer, bool store_pairs, bool r)
        {
            ...
            return sel2_scanner<DCClass> (sq, quantizer, store_pairs, r);
        }



        template<class Similarity>
        InvertedListScanner* sel1_scanner
